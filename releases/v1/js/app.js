...
(function () {
  ...
  var labels = aside.querySelectorAll('[data-rail-nav] > span:not([data-rail-icon])');
  var nav = aside.querySelector('nav');
  var STORAGE_KEY = 'mf-rail-collapsed';
  var expanded = true;
  ...
  function saveCollapsedPref(isCollapsed) {
    try {
